---
title: "daapr: A minimalist example with local data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{daapr: A minimalist example with local data}
...
building data products on stash. 
...
board_params_set_dried <- fn_dry(board_params_set_local(board_alias = "<ALIAS>",
                                                        folder = "<FOLDER_PATH>"))

# Dry function call to setting credentials -- none needed for local board
# TODO: add option for no credentials, this is a placeholder
creds_set_dried <- fn_dry(2)
...
dpbuild::dp_activate(project_path = dp_repo)
