---
title: "daapr: Update input data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{daapr: Update input data}
...
`dpbuild::dp_clone()`, and add folder `input_files` to the top directory as the 
location for depositing data.
