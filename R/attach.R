#' The following is taken from https://github.com/tidyverse/tidyverse/blob/master/R/attach.R
#' with minimal modification

#' @noRd
pkgs <- c("dpi", "dpbuild", "dpdeploy")
...
daapr_attach <- function() {
  ...
  msg(
    cli::rule(
      ...
      right = paste0("daapr ", package_version("daapr"))
    ),
    startup = TRUE
  )
