...
> packages have been merged into daapr itself.
> [`library(daapr)`](https://rdrr.io/r/base/library.html) is now all
> that is needed, and code calling `dpi::`, `dpbuild::`, or `dpdeploy::`
> should call `daapr::` instead. See
