...
> releases will be published there. This repository is no longer actively maintained but will
> remain available for anyone who needs older package version.
>
> As of **daapr v1.0.0**, the separate `dpi`, `dpbuild`, and `dpdeploy` packages have
> been merged into daapr itself. `library(daapr)` is now all that is needed, and
> code calling `dpi::`, `dpbuild::`, or `dpdeploy::` should call `daapr::`
> instead. See [NEWS](https://daapr-team.github.io/daapr/news/index.html) for the
